...
> NOTE: pre-cull. FINAL_INDEX not yet locked (Phase 2). These rows track **research progress (Parts I–V, keys 01–52)**; the board becomes the FINAL_INDEX book of record after `/select-book-one`.
