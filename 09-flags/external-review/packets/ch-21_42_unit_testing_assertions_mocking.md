# SCORING PACKET — Printed Chapter 21  (dossier 42_unit_testing_assertions_mocking)
# 1. Paste EVERYTHING below the line into a fresh chat in a DIFFERENT-VENDOR LLM (not Claude).
# 2. Save its one-pager reply VERBATIM as: 03-drafts/42_unit_testing_assertions_mocking/42_unit_testing_assertions_mocking_SCORE_INDEP.md
