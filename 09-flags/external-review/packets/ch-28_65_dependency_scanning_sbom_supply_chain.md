# SCORING PACKET — Printed Chapter 28  (dossier 65_dependency_scanning_sbom_supply_chain)
# 1. Paste EVERYTHING below the line into a fresh chat in a DIFFERENT-VENDOR LLM (not Claude).
# 2. Save its one-pager reply VERBATIM as: 03-drafts/65_dependency_scanning_sbom_supply_chain/65_dependency_scanning_sbom_supply_chain_SCORE_INDEP.md
