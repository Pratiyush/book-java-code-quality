...
The companion module makes the bug runnable: a `volatile` counter whose increment still loses updates, suppressed in the build only so the lost-update test can ship green.
