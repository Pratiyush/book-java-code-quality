# SCORING PACKET — Printed Chapter 08  (dossier 10_immutability_value_design)
# 1. Paste EVERYTHING below the line into a fresh chat in a DIFFERENT-VENDOR LLM (not Claude).
# 2. Save its one-pager reply VERBATIM as: 03-drafts/10_immutability_value_design/10_immutability_value_design_SCORE_INDEP.md
