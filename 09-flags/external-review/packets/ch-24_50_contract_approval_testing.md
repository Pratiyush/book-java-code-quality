# SCORING PACKET — Printed Chapter 24  (dossier 50_contract_approval_testing)
# 1. Paste EVERYTHING below the line into a fresh chat in a DIFFERENT-VENDOR LLM (not Claude).
# 2. Save its one-pager reply VERBATIM as: 03-drafts/50_contract_approval_testing/50_contract_approval_testing_SCORE_INDEP.md
