# SCORING PACKET — Printed Chapter 18  (dossier 38_custom_rules_codegen_lombok)
# 1. Paste EVERYTHING below the line into a fresh chat in a DIFFERENT-VENDOR LLM (not Claude).
# 2. Save its one-pager reply VERBATIM as: 03-drafts/38_custom_rules_codegen_lombok/38_custom_rules_codegen_lombok_SCORE_INDEP.md
