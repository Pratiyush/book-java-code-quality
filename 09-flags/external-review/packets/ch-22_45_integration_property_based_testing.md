# SCORING PACKET — Printed Chapter 22  (dossier 45_integration_property_based_testing)
# 1. Paste EVERYTHING below the line into a fresh chat in a DIFFERENT-VENDOR LLM (not Claude).
# 2. Save its one-pager reply VERBATIM as: 03-drafts/45_integration_property_based_testing/45_integration_property_based_testing_SCORE_INDEP.md
