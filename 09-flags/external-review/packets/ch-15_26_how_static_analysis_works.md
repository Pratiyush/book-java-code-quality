# SCORING PACKET — Printed Chapter 15  (dossier 26_how_static_analysis_works)
# 1. Paste EVERYTHING below the line into a fresh chat in a DIFFERENT-VENDOR LLM (not Claude).
# 2. Save its one-pager reply VERBATIM as: 03-drafts/26_how_static_analysis_works/26_how_static_analysis_works_SCORE_INDEP.md
