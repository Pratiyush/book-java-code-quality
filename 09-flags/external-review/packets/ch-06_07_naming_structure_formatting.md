# SCORING PACKET — Printed Chapter 06  (dossier 07_naming_structure_formatting)
# 1. Paste EVERYTHING below the line into a fresh chat in a DIFFERENT-VENDOR LLM (not Claude).
# 2. Save its one-pager reply VERBATIM as: 03-drafts/07_naming_structure_formatting/07_naming_structure_formatting_SCORE_INDEP.md
