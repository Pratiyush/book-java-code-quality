...
PIPELINE="{{PIPELINE_REL}}"          # e.g. 00-strategy/PIPELINE.md (the step authority; scanned for ghost refs)
...
WIRED_DOCS="{{WIRED_DOCS}}"          # e.g. "00-strategy/PIPELINE.md CLAUDE.md AGENTS.md 00-strategy/READ-MAP.md"
LOG="{{LOG_REL}}"                    # e.g. 10-logs/activity.jsonl  (USAGE evidence for agents)
# Tool-directory globs (where each kind of tool lives). Adjust only if your repo
# nests .claude/ differently.
AGENTS_GLOB="{{AGENTS_GLOB}}"        # e.g. .claude/agents/*.md
COMMANDS_GLOB="{{COMMANDS_GLOB}}"    # e.g. .claude/commands/*.md
SKILLS_GLOB="{{SKILLS_GLOB}}"        # e.g. .claude/skills/*/SKILL.md
SCRIPTS_GLOB="{{SCRIPTS_GLOB}}"      # e.g. .claude/scripts/*.sh
...
COMMANDS_DIR_REL="{{COMMANDS_DIR_REL}}"  # e.g. .claude/commands
