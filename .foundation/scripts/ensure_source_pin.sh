...
AUTHORITY_REPO="{{REPO_URL}}"     # e.g. https://github.com/quarkusio/quarkus.git
AUTHORITY_TAG="{{TAG}}"           # e.g. 3.33.2 (release tag / edition label)
AUTHORITY_SHA="{{SHA}}"           # e.g. 2f9a60b84d3338f5b81cd83a2b4b853c41071a0f
CLONE_PATH="{{CLONE_PATH}}"       # e.g. /tmp/quarkus-3.33.2 (local pinned-source dir)
DOCS_SUBDIR="{{DOCS_SUBDIR}}"     # e.g. docs/src/main/asciidoc (file count sanity-check; "." if flat)
