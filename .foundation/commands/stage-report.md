...
1. Runs **`.claude/scripts/stage_report.sh [label]`**, which bundles:
   ...
   - writes `{{LOGS_DIR_REL}}/STAGE-REPORT-<date>.md` (e.g. `10-logs/STAGE-REPORT-<date>.md`).
...
`LEDGER.md` §1 · `01-index/CHAPTER-TRACKER.md` · the generated `{{LOGS_DIR_REL}}/STAGE-REPORT-<date>.md`. Do not read the activity log whole — the scripts parse it.
