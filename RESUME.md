...
1. **Keep drafting Phase 3, main agent only.** Next: Ch 6 (keys 07+17+34, naming/formatting), then Ch 7+ across the 47 locked chapters. Per draft: 12-section spine (`00-strategy/templates/CHAPTER-TEMPLATE.md`), facts traced to `SOURCE-PIN.md`, neutrality + honest-limitations floors, write `03-drafts/NN_slug/NN_slug_v1.md` + `_SCORE.md`, **banned-phrasing sweep BEFORE commit**, update `CHAPTER-TRACKER.md`, commit + push.
