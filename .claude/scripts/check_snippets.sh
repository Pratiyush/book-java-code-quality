...
#          Book types with the build/compile gate turned off=example-build DROP this script — see
...
APPROVED_DIR_REL="04-approved"  # e.g. 04-approved (default scan dir)
EXTRACT_REL=".claude/scripts/extract_snippet.sh"            # e.g. .claude/scripts/extract_snippet.sh
# =====================================================================
