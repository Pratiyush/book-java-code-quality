...
#          Book types with the build/compile gate turned off=example-build (science / business /
...
CODE_ROOT_REL="08-companion-code"      # e.g. 08-companion-code (dir under repo root holding modules)
