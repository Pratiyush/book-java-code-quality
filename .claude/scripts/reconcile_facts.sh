...
DEFAULT_VER="multi-authority (see SOURCE-PIN.md; no single tag)"                  # e.g. 3.33.2 (fallback pinned version)
PIN_FILE_REL="00-strategy/SOURCE-PIN.md"        # e.g. 00-strategy/SOURCE-PIN.md
DRAFTS_DIR_REL="03-drafts"    # e.g. 03-drafts
APPROVED_DIR_REL="04-approved" # e.g. 04-approved
LEDGER_REL="LEDGER.md"            # e.g. LEDGER.md (continuity bible)
