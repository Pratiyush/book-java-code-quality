...
| *Out of the Crisis* — W. Edwards Deming | **MIT Press / MIT CAES, 1982 (rev. 1986)** · ✅ web-verified 2026-06-28 (Ch 4/key 06) | build quality *into* the process rather than inspecting it in at the end; defects trace to the system over individuals (drive out fear) — the shift-left lineage. Paraphrased + attributed in-body, never quoted verbatim |
...
| Werner Vogels — "you build it, you run it" (operational-ownership coinage) | ***ACM Queue*, "A Conversation with Werner Vogels"** (Jim Gray, interviewer), **2006** — Amazon CTO; "you build it, you run it" pushes operational responsibility to the team that wrote the service, on the documented rationale that doing so "greatly enhanced the quality of the services." Corroborated by the official **AWS News Blog** (Jeff Barr, **2006-05-16**) — ACM Queue's own page is 403-gated to the fetcher, so the AWS blog is the citable public corroboration · ✅ web-verified 2026-06-28 (Ch 4/key 06); cited dated-at-use | queue.acm.org/detail.cfm?id=1142065 ; aws.amazon.com/blogs/aws/acm_queue_inter/ |
