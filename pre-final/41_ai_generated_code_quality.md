...
- **Routing** — AI review + governance → Ch 42 (98/100); security/OWASP → Ch 30/31 (69/70/71/72/74); SCA/hallucinated-deps → Ch 28 (65/66); tests → Part V; mutation → Ch 23 (47); coverage theatre → Ch 23 (48/80); property-based → Ch 22 (46); refactoring/characterization → Ch 39 (91/92); deterministic transforms → Ch 40 (94); review/size → Ch 37 (84); gate → Ch 33 (76); date-every-stat folklore → Ch 1/2 (04); provenance → front matter. AI-stat provenance RESOLVED 2026-06-28 (web-verify): all figures dated+attributed to verified primaries — the four AI-era primaries are now PINNED as **SOURCE-PIN §8** rows (Pearce et al. arXiv 2108.09293 "~40%" · Veracode *2025 GenAI Code Security Report* 2025-07-30 "45% / XSS 86% / Java 72%" · Spracklen et al. arXiv 2406.10279 "19.7% hallucinated" · CodeScene/Tornhill 2025-03-03 three-guardrails + "double-bookkeeping") and cited as `SOURCE-PIN §8`; the two MECHANISM papers (arXiv 2502.01853 / 2409.19182) stay cited inline as dated primaries (not pinned). The only residual flag is AI productivity % → Ch 42 (09-flags/100). Every AI statistic stays dated+attributed, never timeless — a §8 pin formalizes the source, it does not make any figure a timeless constant.
