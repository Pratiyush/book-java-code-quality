...
- **Routing** — toolchain → Ch 3 (05); baseline/ratchet/adoption → Ch 38 (87); new-code gates → Ch 33/34 (76/80); characterization/seams/refactor/strangler/migration → Ch 39 (91/92/93/95); approval → Ch 24 (52); debt/hotspots → key 59; Error Prone/Refaster → Ch 16 (30); CI gates → Ch 33 (75); review → Ch 37 (84); style-churn → Ch 6/37 (86); metrics/Goodhart → Ch 38 (85/88/04); culture → Ch 1 (06); maturity → key 110. SOURCE-PIN §7 canon: Feathers/Fowler cross-ref Ch 39 TO-PIN.
