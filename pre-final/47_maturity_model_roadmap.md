...
> **Stage 2 — Deepen.** SpotBugs with FindSecBugs (Chapter 16); SCA and SBOM (Chapter 28); ArchUnit (Chapter 26); a SonarQube quality gate (Chapter 17); mutation testing on critical code (Chapter 23); CI speed work (Chapter 33). The fuller analyzer and security layers, once the basics hold.
