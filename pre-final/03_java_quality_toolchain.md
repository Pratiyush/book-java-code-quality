...
```xml
          <compilerArgs>
            <arg>-Xlint:all,-processing</arg>             <arg>-Werror</arg>                          </compilerArgs>
```
...
```xml
            <configuration>
              <effort>Max</effort>                               <threshold>Medium</threshold>                      <includeTests>false</includeTests>
...
```xml
            <executions>               <execution><id>agent</id>
