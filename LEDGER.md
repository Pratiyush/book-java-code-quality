...
| 3 — Draft + Gate | Draft confirmed chapters through the gated pipeline | **IN PROGRESS** — pilot Ch 1 drafted (v1 + SCORE 40/50; floors A/B/C-source PASS; FLOOR-C compile = PENDING-RUNTIME, no JDK). 13/47 drafted (Parts I-II complete + Part III Ch 13 of 13-14). Next: Ch 14 (keys 22+24+25, virtual threads, structured concurrency & concurrency testing) — closes Part III. |
