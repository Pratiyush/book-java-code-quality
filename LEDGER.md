...
| 3 — Draft + Gate | Draft confirmed chapters through the gated pipeline | **IN PROGRESS** — pilot Ch 1 drafted (v1 + SCORE 40/50; floors A/B/C-source PASS; FLOOR-C compile = PENDING-RUNTIME, no JDK). 11/47 drafted (Part I complete + Part II Ch 5-11 of 5-12). Next: Ch 12 (keys 19+61, code smells, design patterns & anti-patterns) — closes Part II. |
