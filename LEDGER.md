...
| 3 — Draft + Gate | Draft confirmed chapters through the gated pipeline | **IN PROGRESS** — pilot Ch 1 drafted (v1 + SCORE 40/50; floors A/B/C-source PASS; FLOOR-C compile = PENDING-RUNTIME, no JDK). 14/47 drafted (Parts I-III COMPLETE: Ch 1-14). Next: Ch 15 (key 26, how static analysis works) — opens Part IV. |
