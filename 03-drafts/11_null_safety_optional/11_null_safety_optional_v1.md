...
⚠ Residual verify-at-pin (genuinely unverifiable / deferred): Checker Framework soundness-sentence quote (CF manual, outside pin); Sonar/SpotBugs/Error Prone rule default-activation state. (NullAway FSE'19 overhead figures + "never due to..." quote — RESOLVED, web-verified 2026-06-28 against arXiv:1907.02127.) ⚠ AHEAD-OF-PIN: Spring 7/Boot 4 + IntelliJ 2025.3 JSpecify adoption; Valhalla null-restricted types. (NullAway 0.13.4 is now the pin, not ahead of it.)
