...
> **AHEAD-OF-PIN** Markdown documentation comments (`///`, JEP 467) ship in **JDK 23**, past the Java 21 anchor. Treat them as a Java 25-era delta, not anchor fact; formatter support has lagged (google-java-format issue #1193). Do not adopt `///` while pinned to 21.
