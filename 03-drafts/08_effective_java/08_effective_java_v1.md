...
- Figure 5.2 — the records "serve not retire" decision: is it transparent immutable data with no invariants? → record; else compact-constructor record / hand-written. Trace to JEP 395 + EJ item.
-->
