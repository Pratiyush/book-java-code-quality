...
The Error Prone-style form needs no runtime code at all: the banned floating-point factory is annotated so a compile-time check flags every caller not on the allowlist.
